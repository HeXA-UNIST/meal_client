...
- **iOS home widget**: `ios/BapUWidget/` contains a static, small WidgetKit extension. It reads the App Group raw caches, displays the dormitory cafeteria, and chooses the meal from the current time and operating hours. It intentionally has no user configuration intent.
