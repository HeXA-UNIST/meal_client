...
UNIST 구내식당 메뉴를 확인할 수 있는 Flutter 애플리케이션입니다. (HeXA-UNIST)
...
- 한국어 / 영어 지원
- 설정 화면 (테마 / 알레르기 / 알림 / 위젯 — 알레르기·알림·위젯은 저장만 되는 플레이스홀더)
...
- [docs/nested_page_scroll_analysis.md](docs/nested_page_scroll_analysis.md) — 커스텀 스크롤 시스템 분석
